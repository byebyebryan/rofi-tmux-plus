...
the ordered action cycle, with wraparound. The prompt and persistent hint show
the active action. Enter opens or begins a kill confirmation for the session
